...
# ])
# SOUTHPOLE_IS_BRANCH_POINT = False

# Octahedron
# BRANCH_POINTS = jnp.asarray([
# 	[      jnp.pi / 2.0,       jnp.pi / 2.0,       jnp.pi / 2.0,       jnp.pi / 2.0],
# 	[1.0 * jnp.pi / 4.0, 3.0 * jnp.pi / 4.0, 5.0 * jnp.pi / 4.0, 7.0 * jnp.pi / 4.0]
# ])
# SOUTHPOLE_IS_BRANCH_POINT = True
...
# # Cube
# BRANCH_POINTS = jnp.asarray([
# 	[jnp.arccos(1.0/3.0), jnp.arccos(1.0/3.0), jnp.arccos(1.0/3.0), jnp.arccos(-1.0/3.0), jnp.arccos(-1.0/3.0), jnp.arccos(-1.0/3.0)], 
# 	[ 1.0 * jnp.pi / 6.0,  5.0 * jnp.pi / 6.0,  9.0 * jnp.pi / 6.0,   3.0 * jnp.pi / 6.0,   7.0 * jnp.pi / 6.0,  11.0 * jnp.pi / 6.0]
# ])
# SOUTHPOLE_IS_BRANCH_POINT = True

# Dodecahedron
BRANCH_POINTS = dodecahedron.sphericalCoordinates
SOUTHPOLE_IS_BRANCH_POINT = True

# Are the branching points allowed to move during training?
BRANCHING_POINTS_TRAINABLE = False
MINIMAL_BRANCH_DISTANCE = 0.0000001
